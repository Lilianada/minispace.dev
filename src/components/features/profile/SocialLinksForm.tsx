 ...
 * 
 * Allows users to update their social media links.
 */
'use client';
...
export function SocialLinksForm({ onUpdate }: SocialLinksFormProps) {
  const { userData, refreshUserData } = useAuth();
  const { toast } = useToast();
  const [isLoading, setIsLoading] = useState(false);
  
  // Initialize state from user data or empty values
